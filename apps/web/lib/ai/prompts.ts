...
You receive validated FCF JSON and authoritative calculation outputs.

Hard rules:
- Use EXACT numbers, units, and pass/fail flags from CalcResult; never recompute or adjust.
...
type ExplanationUserTemplateInput = {
  ...
  calcResult: string; // stringified CalcResult

...
**Note**: Location controls require datum references. Position is the most commonly used GD&T control. Concentricity and Symmetry were removed from ASME Y14.5-2018; use Position instead.

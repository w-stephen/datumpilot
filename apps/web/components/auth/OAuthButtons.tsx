...
function OAuthButton({ provider, icon, label }: OAuthButtonProps) {
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "text-slate-700 dark:text-slate-300 font-mono text-xs font-medium",
        "hover:border-accent-500/30 hover:bg-accent-500/5 transition-all",
